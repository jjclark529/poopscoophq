...
export default function AdminLoginPage() {
  const [email, setEmail] = useState("info@doctordoo.com");
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-6">
              <div className="w-16 h-16 mx-auto mb-4">
                <img src="/logo.png" alt="PoopScoop HQ" className="w-full h-full object-contain" />
              </div>
              <h1 className="text-2xl font-bold text-gray-900">Admin Backoffice</h1>
              <p className="text-sm text-gray-500 mt-1">PoopScoop HQ Management Console</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
              ...
              <button type="submit" className="w-full py-3 bg-red-600 hover:bg-red-700 text-white rounded-xl text-sm font-bold transition-colors flex items-center justify-center gap-2">
            ...
            <p className="text-xs text-gray-400 text-center mt-6">
              This area is restricted to authorized PoopScoop HQ administrators only.<br />
