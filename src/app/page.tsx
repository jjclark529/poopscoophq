...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white flex flex-col">
      {/* Hero */}
      <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 pt-8 pb-10 flex-1">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          {/* Left column */}
          <div>
            <div className="mb-6 flex justify-center lg:justify-start">
              <QuoteLogo size={280} className="drop-shadow-2xl sm:w-[360px] lg:w-[460px]" />
            </div>
            <p className="text-lg sm:text-xl text-blue-200 mb-5 text-center lg:text-left">Fast, polished quoting for pet waste removal businesses</p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-5 text-center lg:text-left">
              Quote jobs faster.
              <br />
              Close more yards.
            </h2>
            <p className="text-lg sm:text-xl text-blue-100 max-w-xl mb-8 text-center lg:text-left mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6">
              <Link href="/login" className="px-7 py-3.5 rounded-xl border border-white/20 hover:bg-white/10 transition-colors text-lg font-medium text-center">
                Sign In
              </Link>
              <Link href="/register" className="px-7 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 transition-colors font-semibold flex items-center justify-center gap-2 text-lg">
